<template>
  <div class="audit-logs-page">
    ...
    <el-card class="logs-card">
      <el-table :data="filteredLogs" v-loading="loading" style="width: 100%" stripe height="calc(100vh - 240px)">
...
async function fetchLogs() {
  ...
  try {
    ...
    ElMessage.error("Failed to load audit logs: " + (e.response?.data?.message || e.message));
  } finally {
    loading.value = false;
  }
}
